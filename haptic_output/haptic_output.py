...
class HapticOutput:
    ...
    def __init__(self, i2cBus):
        ...
        self.north = adafruit_drv2605.DRV2605(i2cBus[0])
    ...
    def play_effect(self, effect_id, delay=0, count=1):
        ...
        self.south.sequence[0] = self.north.sequence[0] = self.west.sequence[0] = self.east.sequence[0] = adafruit_drv2605.Effect(effect_id)
    ...
    def play_sequence(self, sequence):
        ...
        for button in sequence:
            self.south.sequence[0] = self.north.sequence[0] = self.west.sequence[0] = self.east.sequence[0] = adafruit_drv2605.Effect(self.map_button_to_effect(button))
            self.south.play()
            self.north.play()
            self.east.play()
            self.west.play()
